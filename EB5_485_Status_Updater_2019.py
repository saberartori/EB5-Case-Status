...
if __name__ == '__main__':
    ## Read CSV
    df_raw = pd.read_csv(f"FY{FY_YEAR}/CaseNum-all_status.csv")
    df_raw['CaseNum'] = df_raw['CaseNum'].astype(str)

    ## Default Parma
    caseNum_list = df_raw.CaseNum.unique().tolist()
    ...
    df = pd.concat([df_raw, df_new_status])
